...
//  Product /////////////////////////
  ...
  function Product(id, name, price, description, cover, badge, popular, category1, category2, category3, color1, color2) {
  ...
  const product2 = new Product (2, "Штапель принт сакура", "123.00", "Артикул: W-5129", "/images/products/product_2.jpg", "popular", "штапель", "summer", "dress", "green", "yellow")
  // конструктор створює новий об'єкт, в який передаються всі його властивості

  const product3 = new Product (3, "Костюмна Prima під вовну", "237.80", "Артикул: М-16056", "/images/products/product_3.jpg", "Sale", "костюмна", "winter", "black", "gray")

  const product4 = new Product (4, "Креп-мосс платтяний", "98.40", "Артикул: W-1883", "/images/products/product_4.jpg", "New", "креп", "summer", "blue", "green")

// //////////////////////////////////

// Cart /////////////////////////////

const currency = total => parseFloat(Math.round(total * 100) / 100).toFixed(2);                  // підраховує вартість кількох одиниць
...
function Cart(shipping = 0) {
  ...
  this.addItemToCart = function(product) {
    ...
    for (let item in cart) {
      if(cart[item].id === product.id) {    // перевіряємо, чи є вже продукт у кошику
